...
@Model(adaptables = SlingHttpServletRequest.class, adapters = {ComponentExporter.class}, resourceType = WeatherModel.RESOURCE_TYPE)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class WeatherModel implements ComponentExporter {

  static final String RESOURCE_TYPE = "/apps/wknd-events/components/content/weather";
